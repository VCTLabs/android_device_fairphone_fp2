...
BOARD_KERNEL_CMDLINE := initcall_debug=1 androidboot.hardware=qcom kgdboc=ttyHSL0,115200 kgdbwait console=ttyHSL0,115200n8 user_debug=31 msm_rtb.filter=0x3b7 ehci-hcd.park=3 androidboot.bootdevice=msm_sdcc.1
BOARD_KERNEL_SEPARATED_DT := true

BOARD_CUSTOM_BOOTIMG_MK := device/fairphone/FP2/mkbootimg.mk
TARGET_KERNEL_SOURCE := kernel/fairphone/FP2
TARGET_KERNEL_CONFIG := fairphone-debug_defconfig
