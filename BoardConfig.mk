...
BOARD_KERNEL_CMDLINE := initcall_debug=1 androidboot.hardware=qcom kgdboc=ttyMSM0,115200 kgdbwait console=ttyMSM0,115200n8 user_debug=31 msm_rtb.filter=0x3b7 ehci-hcd.park=3 androidboot.bootdevice=msm_sdcc.1
